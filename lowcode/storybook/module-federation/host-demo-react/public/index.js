(function (root, factory) {
  ...
  (() => {
    ...
    var __webpack_modules__ = {
      "../node_modules/.pnpm/@module-federation+error-codes@0.8.2/node_modules/@module-federation/error-codes/dist/index.cjs.js": function (__unused_webpack_module, exports1) {
      ...
      "../node_modules/.pnpm/@module-federation+runtime-tools@0.8.2/node_modules/@module-federation/runtime-tools/dist/runtime.cjs.js": function (__unused_webpack_module, exports1, __webpack_require__) {
        var runtime = __webpack_require__("../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/index.cjs.js");
        Object.keys(runtime).forEach(function (k) {
          if ("default" !== k && !Object.prototype.hasOwnProperty.call(exports1, k))
            Object.defineProperty(exports1, k, {
              enumerable: true,
              get: function () {
                return runtime[k];
              },
      ...
      "../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/index.cjs.js": function (__unused_webpack_module, exports1, __webpack_require__) {
        var polyfills = __webpack_require__("../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/polyfills.cjs.js");
        var sdk = __webpack_require__("../node_modules/.pnpm/@module-federation+sdk@0.8.2/node_modules/@module-federation/sdk/dist/index.cjs.js");
        var share = __webpack_require__("../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/share.cjs.js");
        var errorCodes = __webpack_require__("../node_modules/.pnpm/@module-federation+error-codes@0.8.2/node_modules/@module-federation/error-codes/dist/index.cjs.js");
        ...
        async function loadEsmEntry({ entry, remoteEntryExports }) {
          return new Promise((resolve, reject) => {
            try {
              ...
              else if ("undefined" != typeof FEDERATION_ALLOW_NEW_FUNCTION) new Function("callbacks", `import("${entry}").then(callbacks[0]).catch(callbacks[1])`)([resolve, reject]);
        ...
        let Module = class {
          ...
          async get(id, expose, options, remoteSnapshot) {
            ...
            if (!this.inited) {
              ...
              if (void 0 === (null == remoteEntryExports ? void 0 : remoteEntryExports.init))
                share.error(
          ...
          wraperFactory(moduleFactory, id) {
            function defineModuleId(res, id) {
              if (res && "object" == typeof res && Object.isExtensible(res) && !Object.getOwnPropertyDescriptor(res, Symbol.for("mf_module_id")))
              ...
              if (normalizedPreloadExposes.length && "modules" in moduleInfoSnapshot) {
                ...
                moduleAssetsInfo =
                  null == moduleInfoSnapshot
                    ? void 0
                    : null == (_moduleInfoSnapshot_modules = moduleInfoSnapshot.modules)
                    ? void 0
                    : _moduleInfoSnapshot_modules.reduce((assets, moduleAssetInfo) => {
          ...
          async loadRemoteSnapshotInfo(moduleInfo) {
            ...
            if (hostSnapshot && "remotesInfo" in hostSnapshot && !share.getInfoWithoutType(hostSnapshot.remotesInfo, moduleInfo.name).value) {
              if ("version" in moduleInfo || "entry" in moduleInfo)
                hostSnapshot.remotesInfo = polyfills._extends({}, null == hostSnapshot ? void 0 : hostSnapshot.remotesInfo, {
                  [moduleInfo.name]: {
        ...
        class SharedHandler {
          ...
          async loadShare(pkgName, extraOptions) {
            ...
            if (null == shareInfo ? void 0 : shareInfo.scope)
              await Promise.all(
          ...
          initializeSharing(shareScopeName = share.DEFAULT_SCOPE, extraOptions) {
            ...
            if ("version-first" === host.options.shareStrategy || "version-first" === strategy)
          ...
          registerRemote(remote, targetRemotes, options) {
            ...
            if (registeredRemote) {
              const messages = [
                ...
                (null == options ? void 0 : options.force) ? "Hope you have known that OVERRIDE it may have some unexpected errors" : 'If you want to merge the remote, you can set "force: true".',
              ];
              ...
              if (loadedModule) {
                ...
                if (-1 !== remoteInsIndex) {
                  ...
                  needDeleteKeys.forEach(([insId, shareScope, shareName, shareVersion]) => {
                    ...
                    null == (_globalShareScopeMap_insId = globalShareScopeMap[insId]) ||
                      null == (_globalShareScopeMap_insId_shareScope = _globalShareScopeMap_insId[shareScope]) ||
                      null == (_globalShareScopeMap_insId_shareScope_shareName = _globalShareScopeMap_insId_shareScope[shareName]) ||
                      delete _globalShareScopeMap_insId_shareScope_shareName[shareVersion];
                  });
      ...
      "../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/polyfills.cjs.js": function (__unused_webpack_module, exports1) {
        function _extends() {
          _extends =
            Object.assign ||
            function (target) {
      ...
      "../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/share.cjs.js": function (__unused_webpack_module, exports1, __webpack_require__) {
        var polyfills = __webpack_require__("../node_modules/.pnpm/@module-federation+runtime@0.8.2/node_modules/@module-federation/runtime/dist/polyfills.cjs.js");
        var sdk = __webpack_require__("../node_modules/.pnpm/@module-federation+sdk@0.8.2/node_modules/@module-federation/sdk/dist/index.cjs.js");
        ...
        function parseXRanges(range) {
          return range
            .split(/\s+/)
            .map((rangeVersion) =>
              rangeVersion.trim().replace(parseRegex(xRange), (ret, gtlt, major, minor, patch, preRelease) => {
        ...
        function formatShare(shareArgs, from, name1, shareStrategy) {
          ...
          return polyfills._extends(
            ...
            shareArgs,
            {
              ...
              scope: Array.isArray(shareArgs.scope) ? shareArgs.scope : [null != (_shareArgs_scope = shareArgs.scope) ? _shareArgs_scope : "default"],
              ...
              const defaultResolver = () => {
                if (shareConfig.singleton) {
                  if ("string" == typeof requiredVersion && !satisfy(maxOrSingletonVersion, requiredVersion)) {
                    const msg = `Version ${maxOrSingletonVersion} from ${maxOrSingletonVersion && localShareScopeMap[sc][pkgName][maxOrSingletonVersion].from} of shared singleton module ${pkgName} does not satisfy the requirement of ${
                      shareInfo.from
      ...
      "../node_modules/.pnpm/@module-federation+sdk@0.8.2/node_modules/@module-federation/sdk/dist/index.cjs.js": function (__unused_webpack_module, exports1, __webpack_require__) {
        ...
        var polyfills = __webpack_require__("../node_modules/.pnpm/@module-federation+sdk@0.8.2/node_modules/@module-federation/sdk/dist/polyfills.cjs.js");
        ...
        function generateSnapshotFromManifest(manifest, options = {}) {
          ...
          const getPublicPath = () => {
            ...
            if ("auto" === manifest.metaData.publicPath && version)
        ...
        function createScript(info) {
          ...
          if (!script) {
            ...
            if (attrs && !createScriptRes)
              Object.keys(attrs).forEach((name1) => {
                if (script) {
        ...
        function createScriptNode(url, cb, attrs, loaderHook) {
            ...
            try {
              ...
              const script = new vm.Script(`(function(exports, module, require, __dirname, __filename) {${data}\n})`, {
                ...
                importModuleDynamically:
                  null != (_vm_constants_USE_MAIN_CONTEXT_DEFAULT_LOADER = null == (_vm_constants = vm.constants) ? void 0 : _vm_constants.USE_MAIN_CONTEXT_DEFAULT_LOADER) ? _vm_constants_USE_MAIN_CONTEXT_DEFAULT_LOADER : importNodeModule,
              });
          ...
          getFetch()
            .then(async (f) => {
              if ((null == attrs ? void 0 : attrs["type"]) === "esm" || (null == attrs ? void 0 : attrs["type"]) === "module")
              ...
              (error, scriptContext) => {
                if (error) reject(error);
                  ...
                  const remoteEntryKey =
                    (null == info ? void 0 : null == (_info_attrs = info.attrs) ? void 0 : _info_attrs["globalName"]) || `__FEDERATION_${null == info ? void 0 : null == (_info_attrs1 = info.attrs) ? void 0 : _info_attrs1["name"]}:custom__`;
      ...
      "../node_modules/.pnpm/@module-federation+sdk@0.8.2/node_modules/@module-federation/sdk/dist/polyfills.cjs.js": function (__unused_webpack_module, exports1) {
        function _extends() {
          _extends =
            Object.assign ||
            function (target) {
      ...
      "../node_modules/.pnpm/@module-federation+enhanced@0.8.2_@rspack+core@1.1.6_react-dom@19.0.0_react@19.0.0__react@19.0.0_typescript@5.7.2/node_modules/@module-federation/enhanced/dist/src/runtime.js": function (
        ...
        __exportStar(__webpack_require__("../node_modules/.pnpm/@module-federation+runtime-tools@0.8.2/node_modules/@module-federation/runtime-tools/dist/runtime.cjs.js"), exports1);
      ...
      "../node_modules/.pnpm/isomorphic-rslog@0.0.6/node_modules/isomorphic-rslog/dist/browser/index.cjs": function (module1) {
        ...
        var __export = (target, all) => {
          for (var name1 in all)
            __defProp(target, name1, {
              get: all[name1],
              enumerable: true,
            });
        };
...
${handleError(rest.join("\n"))}`;
        ...
        function gradient(message) {
          if (!supportColor()) return [message];
          const chars = [...message];
    ...
    /* ESM import */ var _module_federation_enhanced_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      "../node_modules/.pnpm/@module-federation+enhanced@0.8.2_@rspack+core@1.1.6_react-dom@19.0.0_react@19.0.0__react@19.0.0_typescript@5.7.2/node_modules/@module-federation/enhanced/dist/src/runtime.js"
    );
    /* ESM import */ var _module_federation_enhanced_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(_module_federation_enhanced_runtime__WEBPACK_IMPORTED_MODULE_0__);
    ...
    class Runtime {
      ...
      loadRemote(component) {
        return (0, _module_federation_enhanced_runtime__WEBPACK_IMPORTED_MODULE_0__.loadRemote)(component);
      }
    }
    /* ESM default export */ const __WEBPACK_DEFAULT_EXPORT__ = Runtime;
